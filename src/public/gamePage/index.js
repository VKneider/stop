...
let init = async () => {
	...
	if(call.status == 200){
        ...
        let gameModal = await slice.getInstance("gameModal", { roomPlayers: roomCall.players ,room: room, role:call.role, user:call.user, nickname:call.nickname, socket:socket, letters: roomCall.letters });
